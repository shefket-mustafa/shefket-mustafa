...
- [VinSpec](https://vin-spec.vercel.app/) – Vehicle inspection reports app built with **React**, **TypeScript**, **Material UI**, and **Tailwind CSS**. Uses the **NHTSA VPIC API** to fetch and decode VIN numbers, providing detailed vehicle data.
