...
- [Modern Store](https://modern-store-five.vercel.app/) – A **full-stack e-commerce application** built with **React (TypeScript)**, **Express.js**, **MongoDB**, and **Tailwind CSS**. Features include full admin panel (add/edit/delete products), JWT authentication, filtering, sorting, search, categories, color filtering, Zustand cart, and a responsive UI. Backend deployed on Render.
...
- [My Bookstore](https://my-bookstore-react-proj.vercel.app) - (Currently migrating back end from MongoDB to PostgreSQL) Full-stack CRUD app with **authentication**, **likes**, **search**, and **MongoDB backend** deployed via Render. Built with **React** and **Express.js**
